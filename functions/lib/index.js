...
exports.dailyDataRefresh = void 0;
 ...
 */
async function getYouTubeLinks(userId) {
    var _a;
    try {
        const docRef = db.collection('youtube').doc(userId);
        const docSnap = await docRef.get();
        if (docSnap.exists) {
            return ((_a = docSnap.data()) === null || _a === void 0 ? void 0 : _a.links) || [];
        }
    }
    catch (error) {
 ...
 */
async function getInstagramLinks(userId) {
    var _a;
    try {
...
async function getVideoStatistics(videoIds, apiKey) {
    ...
    try {
        ...
        if (!response.ok) {
            ...
            console.error('YouTube API Error:', ((_a = errorData.error) === null || _a === void 0 ? void 0 : _a.message) || response.statusText);
        ...
        return data.items.map((item) => {
            ...
            return ({
                ...
                thumbnailUrl: ((_a = item.snippet.thumbnails.high) === null || _a === void 0 ? void 0 : _a.url) || ((_b = item.snippet.thumbnails.medium) === null || _b === void 0 ? void 0 : _b.url),
 ...
 */
async function saveVideoAnalytics(userId, videoData) {
 ...
 */
async function fetchInstagramReelStats(shortcode, apiKey) {
    var _a, _b, _c, _d, _e;
    ...
    try {
        ...
        return {
            ...
            caption: (_a = postData.caption) === null || _a === void 0 ? void 0 : _a.text,
            thumbnailUrl: (_d = (_c = (_b = postData.image_versions2) === null || _b === void 0 ? void 0 : _b.candidates) === null || _c === void 0 ? void 0 : _c[0]) === null || _d === void 0 ? void 0 : _d.url,
            username: (_e = postData.user) === null || _e === void 0 ? void 0 : _e.username,
 ...
 */
async function saveInstagramPostAnalytics(userId, postData) {
    ...
    for (const user of users) {
        ...
        if (apiKeys.youtube) {
            ...
            if (youtubeLinks.length > 0) {
                ...
                const videoIds = youtubeLinks.map(extractYouTubeVideoId).filter((id) => id !== null);
            ...
            if (instagramLinks.length > 0) {
                ...
                for (const link of instagramLinks) {
                    ...
                    if (shortcode) {
                        ...
                        await saveInstagramPostAnalytics(user.id, Object.assign(Object.assign({}, postStats), { reelUrl: link }));
